...
public class DistanceFunctionTest extends SolrTestCaseJ4 {
  ...
  public static void beforeClass() throws Exception {
    initCore("solrconfig.xml", "schema12.xml", "src/test/test-files/solr");
  }
  ...
  public void testHaversine() throws Exception {
    ...
    final String GH_FLD = "point_hash";
    assertU(adoc("id", "1", "x_td", "0", "y_td", "0", GH_FLD, "32.7693246, -79.9289094"));
    assertU(adoc("id", "2", "x_td", "0", "y_td", String.valueOf(Math.PI / 2), GH_FLD, "32.7693246, -79.9289094"));
    assertU(adoc("id", "3", "x_td", String.valueOf(Math.PI / 2), "y_td", String.valueOf(Math.PI / 2), GH_FLD, "32.7693246, -80.9289094"));
    assertU(adoc("id", "4", "x_td", String.valueOf(Math.PI / 4), "y_td", String.valueOf(Math.PI / 4), GH_FLD, "32.7693246, -80.9289094"));
    assertU(adoc("id", "5", "x_td", "45.0", "y_td", "45.0", GH_FLD, "32.7693246, -81.9289094"));
    ...
    assertQ(req("fl", "*,score", "q", "{!func}geodist()",
        "sfield",GH_FLD,"pt","32,-79", "fq", "id:1"), "//float[@name='score']='122.171875'");

    assertQ(req("fl", "id,point_hash,score", "q", "{!func}recip(geodist(point_hash, 32, -79), 1, 1, 0)"),
            "//*[@numFound='7']", 
            "//result/doc[1]/str[@name='id'][.='6']",
            "//result/doc[2]/str[@name='id'][.='7']"//all the rest don't matter
            );

    assertQ(req("fl", "*,score", "q", "{!func}geodist("+GH_FLD+", 32, -79)", "fq", "id:1"), "//float[@name='score']='122.171875'");
